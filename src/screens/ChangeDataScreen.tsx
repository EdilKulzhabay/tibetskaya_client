  ...
  const handleChangeData = async () => {
    try {
      ...
      if (form.userName != user?.userName) {
        await apiService.updateData(clientId, 'userName', form.userName);
      }
      if (form.mail != user?.mail) {
        await apiService.updateData(clientId, 'mail', form.mail);
      }
      if (form.phone != user?.phone) {
        await apiService.updateData(clientId, 'phone', form.phone);
      }
      if (form.password != '' && form.password === form.confirmPassword) {
        await apiService.updateData(clientId, 'password', form.password);
      }
