    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {orders.length > 0 && orders.map((order) => (
          <OrderBlock key={order._id} id={order._id} date={order.date.d} status={order.status} products={order.products} courier={order.courier} address={order.address.actual} totalAmount={order.sum} />
        ))}
      </ScrollView>
      <Navigation />
    </SafeAreaView>
