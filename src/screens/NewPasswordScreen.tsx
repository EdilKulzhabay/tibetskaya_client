...
const NewPasswordScreen: React.FC<{
  ...
  const handleNewPassword = async () => {
    ...
    setLoading(true);
    try {
      const res = await apiService.updateForgottenPassword(
        identifier,
        password,
      );
      if (res.success) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Text style={styles.title}>Установка нового пароля</Text>
        <Text style={styles.subtitle}>Введите новый пароль</Text>
      </View>
        ...
        <View style={{marginTop: 60}}>
          <TouchableOpacity
            ...
            {loading ? (
              ...
              <Text style={styles.loginButtonText}>Сохранить пароль</Text>
            )}
          </TouchableOpacity>
        </View>
      </View>
